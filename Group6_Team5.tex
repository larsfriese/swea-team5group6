...
\begin{figure}[htbp]
    ...
    \centering
    \begin{subfigure}{\textwidth}
        \resizebox{\textwidth}{!}{\includesvg[]{Hermon/Water Intake System Use Case.svg}}
        \caption{Use Case Diagram}
    \end{subfigure}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \centering
    \begin{subfigure}{\textwidth}
        \resizebox{\textwidth}{!}{\includesvg[]{Hermon/Water Intake System Activity.svg}}
		\caption{Activity Diagram}
	\end{subfigure}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \centering
    \begin{subfigure}{\textwidth}
        \includesvg[width=\textwidth]{Hermon/Water Intake System Class.svg}
        \caption{Class Diagram}
    \end{subfigure}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \centering
    \begin{subfigure}{\textwidth}
        \includesvg[width=\textwidth]{Hermon/Water Intake System seq.svg}
        \caption{Sequence Diagram}
    \end{subfigure}
\end{figure}
...
\newpage
	...
	\end{figure}
		...
		\paragraph{Non-functional requirements}
		\begin{itemize}
			\item System should protect bioelectrical impedance data with reliable security strategies
		\end{itemize}
		\newpage
		...
		\begin{figure}[htbp]
			...
			\begin{subfigure}{\textwidth}
				\centering
				\scalebox{0.9}{\includesvg[]{Jiwon/BioelecAnalysis/BioelecAnalysis_activity.svg}}
			\end{subfigure}
			\begin{subfigure}{\textwidth}
...
\section{Lars Friese}
	...
	\begin{center}
		...
		\begin{figure}[htbp]
			...
			\end{subfigure}
		\end{figure}
		\clearpage % Ends the current page and forces a new page
