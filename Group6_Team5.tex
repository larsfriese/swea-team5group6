...
\begin{titlepage}
    ...
    {\huge\bfseries HealthMate Watch}\\[8cm]
...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{|p{0.09\textwidth}|X|p{0.14\textwidth}|p{0.1\textwidth}|p{0.05\textwidth}|p{0.17\textwidth}|}
		...
		Orga.&Declaration of Authorship&non-functional&&&Jiwon Won\\ \hline
		Orga.&Tabular List of all backlog items&non-functional&&&everyone\\ \hline
		Orga.&Business Value for all requirements&non-functional&&&Jiwon Won, Hermon Gimikael, everyone\\ \hline
