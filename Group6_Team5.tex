...
\begin{center}
	...
	{\normalsize \textbf{11 February 2024}\\}\vspace{15pt}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\textwidth]{Jiwon/signature/Hermon} % Adjust the width as needed
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\textwidth]{Jiwon/signature/Howard} % Adjust the width as needed
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\textwidth]{Jiwon/signature/Jiwon} % Adjust the width as needed
